...
Procedure ordenarPorPuntaje (Var V:vectorCodigos);
...
Begin
  For i:=2 To dimF Do
    Begin
      ...
      V[j+1] := actual;
    End;
  WriteLn('Pelicula codigo ',V[dimF].codP,' es la pelicula mejor puntuada con ',V[dimF].puntaje:2:1,' puntos.');
  WriteLn('Pelicula codigo ',V[1].codP,' es la pelicula peor puntuada con ',V[1].puntaje:2:1,' puntos.');
End;
// ------------------------PROGRAMA PRINCIPAL------------------------
