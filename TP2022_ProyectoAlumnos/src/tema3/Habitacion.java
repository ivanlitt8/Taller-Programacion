...
public class Habitacion {
   ...
   private Persona persona;
    ...
    public Habitacion(double costo, boolean ocupada, Persona persona) {
        this.costo = costo;
    ...
    public boolean guardarCliente(Persona persona) {
        if(ocupada){
            ...
            System.out.println("Esta habitacion no ha sido reservada por "+persona.getNombre()+" y se encuentra libre.");
            return false;
        }
    }
    
    public Persona informarCliente() {
        if(ocupada){
            return persona;
        }else{
            return null;
